...
<html>
    ...
    <body>
        ...
        <form action="phpedit.php" method="POST">
            <span class="titulo">Nombre</span><input type="text" name="nombre" value="<?php echo $fotografo->getNombre(); ?>"/><br/>
            <span class="titulo">Apellidos</span><input type="text" name="apellidos" value="<?php echo $fotografo->getApellidos(); ?>" /><br/>
            <span class="titulo">Sexo</span><input type="text" name="sexo" value="<?php echo $fotografo->getSexo(); ?>" /><br/>
            <span class="titulo">Edad</span><input type="number" name="edad" value="<?php echo $fotografo->getEdad(); ?>" /><br/>
            <span class="titulo">Nacionalidad</span><input type="text" name="nacionalidad" value="<?php echo $fotografo->getNacionalidad(); ?>" /><br/>
            <span class="titulo"></span><input type="hidden" name="pkID" value="<?php echo $fotografo->getId()?>" /><br/>
        ...
        <form action="phpedit.php" method="POST" enctype="multipart/form-data">
            <span class="titulo">Nombre Expo</span><input type="text" name="nombreexpo" value="<?php echo $exposicion->getNombreexpo(); ?>"/><br/>
            <span class="titulo">Direccion</span><input type="text" name="direccion" value="<?php echo $exposicion->getDireccion(); ?>" /><br/>
            <span class="titulo">Fecha</span><input type="date" name="fecha" value="<?php echo $exposicion->getFecha(); ?>" /><br/>
            <span class="titulo">Identificador</span><?php echo Util::getSelect("idfotografo", $gestorfotografo->getValuesSelect(), $fotografo = $gestorfotografo->get($id), false); ?><br/>
             <span class="titulo">Cartel</span><input type="file" name="archivo2" />

            <span class="titulo"></span><input type="hidden" name="pkID" value="<?php echo $exposicion->getId()?>" /><br/>
            <span class="titulo"></span><input type="submit" value="send" id="enviocambios" />
        </form> 
        <?php } ?>
                </div>
