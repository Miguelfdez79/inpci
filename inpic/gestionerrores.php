...
<html>
    ...
    <body>
        ...
        <div id="contenedorformulario">
            <div id="formu">
            <form action="login.php" method="post" enctype="multipart/form-data" id="formCongra">
                <fieldset>
                    <legend></legend>
                    <p id="encabezadologin">Your login information is incorrect. Please try again.</p>
                </fieldset>
                <div id="enviarX">
